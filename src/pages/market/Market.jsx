    ...
    <div style={{ backgroundColor: 'black', height: 1000 }}>
      ...
      <div className='row' style={{ height: 60, backgroundColor: '#1e1e1e' }}>
        <div className='col-lg-9 d-flex' style={{ width: 400, marginLeft: 30, marginBottom: 20 }}>
          <input className="form-control me-2 " type="search" placeholder="Search" aria-label="Search" style={{ borderColor: 'rgb(8, 255, 243)', color: 'rgb(8, 255, 243)', backgroundColor: '#1e1e1e' }} />
      ...
      <div className='row' style={{ height: 760, backgroundColor: '#1e1e1e' }}>
        ...
        <div className="shadow rounded">
          <div className="card border-primary mb-3" style={{ height: 750, backgroundColor: '#323232', width: 440, color: 'white'}}>
              <div className="text-center"><h2>Фильтры</h2></div>
